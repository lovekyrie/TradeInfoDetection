...
export default {
  ...
  methods: {
    ...
    dataURLtoFile(data, mime) {//将base64转换为文件
   data = data.split(',')[1];
    ...
    confirmHandle () {
      ...
      console.log(this.dataURLtoFile(imgData,this.filename));
      let str = {base64:imgData,fileName:this.filename}
      this.until.post('/general/file/uploadBase64',str)
              .then(res=>{
                  if(res.status == 200){
                  console.log("上传成功"+res.data);
                   let param ={imgUrl:res.data}

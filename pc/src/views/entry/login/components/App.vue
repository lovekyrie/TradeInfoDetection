...
<div id="container">
  ...
  <div id="main">
    ...
    <form>
      ...
      <div><img src="../img/密码.png"><input type="password" placeholder="请输入密码"> </div>
      <div><img src="../img/验证码.png"><input> </div>
      <div><a href="javascript:void (0)">忘记密码？</a></div>
      <div><button>登录</button><button>取消</button>
      </div>
    </form>

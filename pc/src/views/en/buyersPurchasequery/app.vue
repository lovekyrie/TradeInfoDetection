      ...
      <div class="search">
        <el-form>
            <el-form-item label="Product：">
              <el-input  v-model="searchGdno" placeholder="Product"></el-input>
            </el-form-item>
            <el-form-item label="Supplier：">
              <el-input v-model="searchCustName" placeholder="Supplier"></el-input>
            </el-form-item>
            <el-form-item label="District：">
              <addr @setAddr="getAddr" distCd="0"></addr>
            </el-form-item>
            <el-form-item label="Serial Number：">
              <el-input v-model="searchSn" placeholder="Serial number"></el-input>
            </el-form-item>
            <el-form-item>
...
export default {
  ...
  methods: {
    ...
    toDetail(val){
      ...
      if(this.searchSn){
        window.location.href = '../en/buyersPurchaseDetail.html?pk='+val+'&no='+this.searchSn

      }else {
        window.location.href = '../en/buyersPurchaseDetail.html?pk='+val

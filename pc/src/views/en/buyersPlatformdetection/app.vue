<template>
  <div id="app" v-loading="loading">
    <trade-header :showSearch="showSearch" @search="search" searchText="Services"></trade-header>
    <div class="content">
      <div class="switch">
        <el-row>
          <el-button :class="{active:pageName=='Platform Release'}">Platform Release</el-button>
          <el-button @click="goToOther" :class="{active:pageName=='Third Party Test Organization'}">Third Party Test Organization</el-button>
        </el-row>
      </div>
      <div class="concret">
        <div class="sidebar">
        ...
        <div class="infolist" v-if="ifSearch">
          <detection-search :detectionList="detectionList" detail="buyersPlatformdetectiond.html"></detection-search>
        </div>
        <div class="infolist" v-else>
          <detection-list :detectionList="detectionList" num='1' detail="buyersPlatformdetectiond.html"></detection-list>
        </div>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    goToOther(){
      window.location.href='./buyersOtherdetection.html'
    }
  },
  watch:{
    cd:function () {

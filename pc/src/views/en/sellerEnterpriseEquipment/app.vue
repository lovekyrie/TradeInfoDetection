<template>
  <div id="app" v-loading="loading">
    ...
    <div class="content">
      <div class="el-row">
        <button class="active">Enterprise release</button>
        <button @click="toPersonal">Personal release</button>
      </div>
...
export default {
  ...
  methods: {
    toDetail(val){
      window.location.href = '../en/sellerEnterpriseEquipmentd.html?pk='+val
    },
    ...
    toPersonal(){
      window.location.href='../en/sellerPersonalEquipment.html'
    }
  }
};
</script>

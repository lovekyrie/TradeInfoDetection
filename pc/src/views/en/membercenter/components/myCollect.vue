   ...
   <div class="collect" v-loading="loading">
          ...
          <div class="mainSearch">
            <el-form :inline="true" :model="search" class="demo-form-inline">
              ...
              <el-form-item>
                <el-input class="searchInput_a" v-model="search.name" placeholder="Product name"></el-input>
              </el-form-item>
              <el-form-item>
                <el-input class="searchInput_a" v-model="search.supplierName" placeholder="Supplier"></el-input>
              </el-form-item>
          ...
          <el-table  :data="list" style="width: 100%"  align="left" padding="5px" @row-click="toDetail"  class="cursor">
            ...
            <el-table-column prop="rpNo" label="Serial number" width="200"></el-table-column>
            <el-table-column prop="rpProdNm" label="Product Name"></el-table-column>
            <el-table-column prop="rpSupply" label="Supplier"> </el-table-column>
            <el-table-column prop="rpProdProvNm rpProdCityNm" label="District"  align="center" >
              <template slot-scope="scope">
              {{list[scope.$index].rpProdProvNm}}
                {{list[scope.$index].rpProdCityNm}}
              </template>
            </el-table-column>
            <el-table-column align="center"  prop="Toperation" label="Operate" width="130" >
              <template slot-scope="scope">
                <el-button
                  size="small"

       ...
       <!--中间右侧内容栏-->
        <div class="center">
          ...
          <div class="rightTop">
            ...
            <div class="right_b">
              <p>Account：{{myInfo.usNm}}</p>
              <p>Tel：{{myInfo.mob}}</p>
              <p>Email：{{myInfo.email}}&nbsp;&nbsp;&nbsp;&nbsp;
                <a href="index.html#/accountManager" style="color: rgb(90,127,219);">Account Management ></a>
              </p>
            ...
            <div class="right_c">
              <vue-qr
                ...
                :margin="0"
                ></vue-qr>
              <p style="color: rgb(151,151,151)">My recommendation code</p>
          ...
          <div class="rightBottom">
            ...
            <div class="rightBottom_a">
              ...
              <div class="rightBottom_a_left"><a href="index.html#/myGold">
                <img :src="mygold" alt="My Gold Coins" align="left" style="margin-right: 30px"></a>
                <div style="padding-top: 10px">
                <p style="margin-bottom: 5px;font-size: 16px">My Gold Coins</p>
                <p><a  style="font-size: 14px" href="index.html#/myGold">Check the details of consumption ></a></p>
                </div>
              </div>
              <div class="rightBottom_a_right"><a href="index.html#/myorder">
                <img :src="myorder" alt="Orders" align="left" style="margin-right: 30px"></a>
                <div style="padding-top: 10px">
                  <p style="margin-bottom: 5px;font-size: 16px">Orders</p>
                  <p><a href="index.html#/myorder" style="font-size: 14px">View order status ></a></p>
                </div>
              </div>
            ...
            <div class="rightBottom_b">
              <div class="rightBottom_b_left"><a @click="toReport()">
                <img :src="myreport" alt="Reports" align="left" style="margin-right: 30px"></a>
                <div style="padding-top: 10px">
                  <p style="margin-bottom: 5px;font-size: 16px">Reports</p>
                  <p><a style="font-size: 14px"  @click="toReport()">View report status ></a></p>
                </div>
              </div>
              ...
              <div class="rightBottom_b_right" v-if="type==1"><a href="index.html#/myJob">
                ...
                <div style="padding-top: 10px">
                  <p style="margin-bottom: 5px;font-size: 16px">Talent information</p>
                  <p><a href="index.html#/myJob" style="font-size: 14px">View Talent Information > ></a></p>
                </div>
              </div>
              <div class="rightBottom_b_right" v-if="type==2"><a href="index.html#/talentinfo">
                <img :src="talent" alt="人才信息" align="left" style="margin-right: 30px"></a>
                <div style="padding-top: 10px">
                  <p style="margin-bottom: 5px;font-size: 16px">Recruit Information</p>
                  <p><a href="index.html#/talentinfo" style="font-size: 14px">Check Recruitment Information > ></a></p>
                </div>
              </div>
            </div>
            ...
            <div class="rightBottom_c">
              <div class="rightBottom_c_left"><a href="#" @click="toEntry">
                <img :src="joinIn" alt="My settle-in" align="left" style="margin-right: 30px"></a>
                <div style="padding-top: 10px">
                  <p style="margin-bottom: 5px;font-size: 16px">My settle-in</p>
                  <p><a href="#" style="font-size: 14px" @click="toEntry">Check in ></a></p>
                </div>
              </div>
              <div class="rightBottom_c_right" v-if="type==2">
                <a href="../../views/en/servicecenterPartner.html" v-if="type2 == '40000.150'">
                  <img :src="fabu" alt="Posted information" align="left" style="margin-right: 30px">
                </a>
                <a href="../../views/en/servicecenterDetection.html" v-else>
                  <img :src="fabu" alt="Posted information" align="left" style="margin-right: 30px">
                </a>
                <div style="padding-top: 10px">
                  <p style="margin-bottom: 5px;font-size: 16px">Posted information</p>
                  <p v-if="type2 == '40000.150'"><a href="../../views/en/servicecenterPartner.html" style="font-size: 14px">View the release ></a></p>
                  <p v-else><a href="../../views/en/servicecenterDetection.html" style="font-size: 14px">View the release ></a></p>
                </div>
              </div>
            </div>
          </div>
      ...
      if(this.type==1){ //个人
          ...
          .then(res=>{
            let myData = res.data.items[0]
              if(myData.statCd=='50000.100'){  //审核通过
                window.location.href = '../en/servicecenterSettleInsuccess.html'
              }else {  //待审核及审核未通过,没有入驻过
                window.location.href='../en/servicecenterPersonalEntry.html'
              }
          })
      }else {
        if(this.type2==0){ //未提交入驻
          ...
          if(this.myState=='50000.100'){  //审核通过
            window.location.href='../en/servicecenterPsettlelnSucess.html'
          }else {  //待审核 审核拒绝
            window.location.href='../en/servicecenterPartnerEntry.html?type=edit'
          }
        }else {  //检测机构

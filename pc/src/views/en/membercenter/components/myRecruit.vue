   ...
   <div class="myreport" v-loading="loading">
    ...
    <div class="mainSearch">
      <el-form :inline="true" class="demo-form-inline">
        <el-form-item>
          <el-input class="searchInput_a" v-model="search.stitle" placeholder="Position"></el-input>
        </el-form-item>
        ...
        <el-form-item>
          <el-button @click="toAddJob" class="release">Position Published</el-button>
        </el-form-item>
      </el-form>
    </div>
    <el-table :data="tableData" style="width: 100%" align="left" padding="5px">
      <el-table-column prop="title" label="Position"  align="center">
      ...
      <el-table-column  label="Salary"  align="center">
        <template slot-scope="scope">
          {{tableData[scope.$index].frSala}} - {{tableData[scope.$index].toSala}} /month
        </template>
      </el-table-column>
      <el-table-column  prop="crtTm" label="Time Posted"  align="center">
      </el-table-column>

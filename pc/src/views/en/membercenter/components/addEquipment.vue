<template>
   <div class="add-equip" v-loading="loading">
          ...
          <ul class="mainTitle">
            ...
            <li class="title">Equipment Requirement Published</li>
            <li class="line"><span></span></li>
          </ul>
          ...
          <div class="deviceSub">
            <el-form :model="ruleForm" status-icon :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
              <el-form-item label="Equipment  Name：" prop="nm">
                <el-input v-model="ruleForm.nm"></el-input>
              </el-form-item>
              <el-form-item label="Attribute：" v-if="type==2">
              ...
              <el-form-item label="Price：" prop="dContacts" v-if="type==2">
                <el-input v-model="ruleForm.price"></el-input>
              </el-form-item>
              <el-form-item label="Picture：" v-if="type==2">
              ...
              <el-form-item label="Product  Descriptions：" prop="intro">
              ...
              <el-form-item label="Email：" prop="contEmail">
...
export default {
    data() {
      ...
      return {
        ...
        rules:{
          nm: [
            { required: true, message: 'Please enter the name of the device.', trigger: 'blur' },
          ],
          contEmail: [

<template>
   <div class="add-addr" v-loading="loading">
          ...
          <ul class="mainTitle">
            ...
            <li class="title">Edit Receiving Address</li>
            <li class="line"><span></span></li>
          </ul>
          ...
          <div class="editAddress">
            <el-form :model="ruleForm" status-icon :rules="rules" ref="ruleForm" label-width="100px"
                     class="demo-ruleForm">
              <el-form-item label="Receiver Attention：" prop="receiver">
              ...
              <el-form-item label="Province and city：" prop="place">
                <addr @setAddr="getAddr" :provCd="ruleForm.provCd" :city="ruleForm.cityCd" :distCd="ruleForm.distCd"></addr>
              </el-form-item>

              <el-form-item label="Detailed address：" prop="fullAddress">
...
<script>
  import addr from '@/componentsEn/addr.vue'
export default {
  data() {
    return {
      loading:false,

        ...
        <el-dialog
          ...
          <div class="mainSearch">
            <el-form :inline="true" :model="search" class="demo-form-inline">
              ...
              <el-form-item>
                <el-input class="searchInput_a" v-model="search.orderNum" placeholder="Order Number"></el-input>
              </el-form-item>
              <el-form-item>
                <el-input class="searchInput_a" v-model="search.serviceName" placeholder="Service Name"></el-input>
              </el-form-item>
              <el-form-item label="Order Process：">
              ...
              <el-form-item label="Report Process：">
          ...
          <el-table  :data="tableData" style="width: 100%" align="left" padding="5px"
            ...
            <el-table-column  prop="mxOrdDetePk" label="Order Number" >
            ...
            <el-table-column prop="qty"  label="Quantity" width="80px"  align="center"> </el-table-column>
            <el-table-column prop="crtTm"  label="Order Time" align="center" width="160px" ></el-table-column>
            <el-table-column prop="statNm" label="Order Process" align="center"> </el-table-column>
            <el-table-column label="Price" align="center">
              <template slot-scope="scope">
                <span style="color: red">{{tableData[scope.$index].price}}</span>
              </template>
            </el-table-column>
            <el-table-column prop="repoStatNm" label="Report Process" align="center" ></el-table-column>
            <el-table-column label="OR Code"  align="center" >
              <template slot-scope="scope">
                <img :src="orderCodes">
              </template>
            </el-table-column>
            ...
            <el-table-column  label="Operate" align="center">
              <template slot-scope="scope">
                <a class="payA" @click.stop="pay(tableData[scope.$index].mxOrdDetePk)" v-if="tableData[scope.$index].statCd==='80020.002'?true:false">Pay</a>
                <div class="payA" @click.stop="cancel(tableData[scope.$index])" v-if="tableData[scope.$index].statCd==='80020.001'?true:false">Cancel</div>
              </template>
            </el-table-column>
          </el-table>
        <div class="block">
  ...
  watch:{
    time:function (val) {
     ...
     methods: {
       ...
       cancel(info){
         // console.log(info)
         this.$confirm('Are you sure to cancel the order?', 'Tips', {
           ...
           this.until.postData('/prod/mxordete/edit',JSON.stringify(info))
             .then(res=>{
               if(res.status=='200'){
                 this.$message({
                   message:'Cancellation of success',
                   type:'success'
                 });
               }else {
                 this.$message({

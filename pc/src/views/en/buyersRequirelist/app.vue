<template>
  <div id="app" v-loading="loading">
    <div class="header">
      <trade-header :showSearch="showSearch"  @search="search" :upload="true" :myType="type" :butNm="butNm" searchText="Search Demand"></trade-header>
    </div>
    <div class="content">
...
<script>
  ...
  import requireList from "@/componentsEn/requireList";

  ...
  <div id="app">
    ...
    <div class="content">
        ...
        <div class="proinfo">
          ...
          <div>
            ...
            <div>
              ...
              <el-row>
                <el-button @click="submit">Place the Order</el-button>
              </el-row>
            </div>
          </div>
        </div>
      ...
      <div class="detailinfo">
        ...
        <p>Product Specifications：{{info.rmks}}</p>
        <p>
          <span>Contact：{{info.cont}}</span>
          <span>Tel：{{info.mob}}</span>
        </p>
...
export default {
  ...
  methods: {
    submit(){
      ...
      window.location.href = '../en/buyersReservationservice.html?qty='+this.qty+'&nm='+this.info.nm+'&img='+this.bigImg+'&pk='+this.pk
    },
    handleChange(value) {
      // console.log(value);
    },

<template>
    ...
    <div class="content">
      ...
      <div class="linked">
        ...
        <el-form ref="info" :model="info" :rules="rules">
           <el-form-item label="Supplier Name：" prop="supply">
              <el-input v-model="info.supply"></el-input>
            </el-form-item>
             <el-form-item label="Product Name：" prop="prodNm">
      ...
      <div class="addrTitle">
        <span></span>
        <span>Address</span>
        <p @click="addAddr">Shipping  Address</p>
      </div>
        ...
        <el-row>
          <el-button @click="submitOrder('info')">Submit</el-button>
  ...
  center>
   <div class="upload-content">
    ...
    <div>
      <span>OR Code has been generated, </span>
    </div>
    <div>
      <span>please scan the code to get the order processing details.</span>
    </div>
  </div>
...
import addressManage from "@/componentsEn/addressManage";
...
export default {
  data() {
    return {
      ...
      rules: {
        supply: [
          { required: true, message: 'Please enter supplier', trigger: 'blur' }
        ],
        prodNm: [
  ...
  methods: {
            ...
            .then(res=>{
              ...
              if(res.status=='200'){
                ...
                setTimeout(()=>{
                  ...
                  window.location.href = '../en/index.html#/myorder'
                },2000)
              }else {
                this.$message({
                  message:res.msg,
    ...
    addAddr(){
      window.location.href = '../en/index.html#/addresslist'
    },
    getAddr(){

  ...
  <div id="app" v-loading="loading">
    ...
    <div class="content">
      ...
      <div>
        ...
        <button @click="downLoad">Attachment Download</button>
      </div>
      <div>
        <div>
          Download Number of Gold Coins：<span>{{requireDetail.price}}Gold coin</span>
        </div>
        <!--<div>-->
...
export default {
  ...
  methods:{
    downLoad(){
      ...
      this.$confirm("Gold coins are required to download current attachments"+this.requireDetail.price +
        ",Are you sure you want to download it?？", 'Tips', {

<template>
  <div id="app" v-loading="loading">
    <div class="header">
      <trade-header :showSearch="showSearch" @search="search" :butNm="butNm" searchText="Talents"></trade-header>
    </div>
    <div class="content">
...
import talentRecruit from "@/componentsEn/talentRecruit";

export default {
  data() {
    return {
      butNm:'Release Talents Requirements',
      showSearch: true,
      talentList: [],
      loading:false,
      pageNo:1,
